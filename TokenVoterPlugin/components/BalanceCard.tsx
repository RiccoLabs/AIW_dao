  ...
  const formattedTotal = useMemo(
    () =>
      mint && communityOwnVoterWeight?.value
        ? new BigNumber(power.toString()).shiftedBy(-mint.decimals).toString()
        : undefined,
    [mint, power],
  )
          ...
          <div className="w-full">
            <div className="p-3 rounded-md bg-bkg-1 mb-2">
              ...
              {pluginMint && communityOwnVoterWeight?.value && (
                <VotingPowerPct
                  amount={
                    new BigNumber(communityOwnVoterWeight.value.toString())
                  }
              ...
              <div className="flex flex-col gap-1 mt-2">
                {showDeposit && (
                  <p className="text-xs font-semibold">
                    You have {formattedAvailableTokens} {tokenName} tokens to
                    deposit
                  </p>
                )}
